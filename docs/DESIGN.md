...
- The task date rail starts with Today and continues into upcoming days; an explicit date picker supports planning beyond the visible rail. Overdue tasks use a distinct danger-tinted label, while completed tasks form a clearly labeled group below active work.
