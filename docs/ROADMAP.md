...
| SYNC-QUICK-001 | Single-request mutation acknowledgement and latest-edited Sticky restoration in quick capture | SYNC-SCOPE-001 | ix: streamline quick note sync and resume |
